...
class TweepyAPI(tweepy.API):
    ...
    def home_timeline(self):
        ...
        return bind_api(
            ...
            allowed_param=['count', 'since_id', 'max_id', 'trim_user', 'exclude_replies', 'include_entities'],
            require_auth=True
        )
    ...
    def statuses_lookup(self, id_, *args, **kwargs):
        ...
        return bind_api(
            ...
            payload_type='status', payload_list=True,
            allowed_param=['id', 'include_entities', 'trim_user', 'map', 'include_ext_alt_text', 'include_card_uri'],
            require_auth=True
    ...
    def get_status(self):
        ...
        return bind_api(
            ...
            payload_type='status',
            allowed_param=['id', 'trim_user', 'include_my_retweet',  'include_entities', 'include_ext_alt_text', 'include_card_uri']
        )
    ...
    def media_upload(self, filename, *args, **kwargs):
        ...
        headers, post_data = TweepyAPI._pack_image(filename, max_size, form_field='media', f=f, file_type=file_type)
    ...
    def update_with_media(self, filename, *args, **kwargs):
        ...
        """
        f = kwargs.pop('file', None)
        headers, post_data = TweepyAPI._pack_image(filename, 3072, form_field='media[]', f=f)
        kwargs.update({'headers': headers, 'post_data': post_data})
    ...
    def update_profile_image(self, filename, file_=None):
        """ :reference: https://developer.twitter.com/en/docs/accounts-and-users/manage-account-settings/api-reference/post-account-update_profile_image
            :allowed_param: 'include_entities', 'skip_status'
        """
        headers, post_data = TweepyAPI._pack_image(filename, 700, f=file_)
        return bind_api(
            api=self,
    ...
    def update_profile_banner(self, filename, **kwargs):
        ...
        """
        f = kwargs.pop('file', None)
        headers, post_data = TweepyAPI._pack_image(filename, 700, form_field='banner', f=f)
        return bind_api(
            api=self,
